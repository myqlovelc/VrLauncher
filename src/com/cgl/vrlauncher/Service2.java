...
public class Service2 extends Service {
	...
	private String Process_Name = "com.cgl.vrlauncher:service1";
	...
	public void onCreate() {
		new Thread() {
			public void run() {
				while (true) {
					...
					if(isRun==false){
						try {
							Log.i(TAG, "myqTmac: "+service_2);
							//Toast.makeText(Service2.this, "Service2ø™∆Ù", Toast.LENGTH_SHORT).show();
		...
		//Toast.makeText(this, "Service2ø™∆Ù", Toast.LENGTH_SHORT).show();
	}
	...
	/*public static boolean isServiceRunning(Context context, String serviceName) {
		...
		for (RunningServiceInfo info : lists) {
			if(info.service.getClassName().equals(serviceName)){
				Log.i("Service1ËøõÁ®ã", ""+info.service.getClassName());
				isRunning = true;
			}
		}
